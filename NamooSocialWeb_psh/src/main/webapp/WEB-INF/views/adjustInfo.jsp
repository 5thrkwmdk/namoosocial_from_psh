	...
	<div class="navbar navbar-static">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="${ctx}/main" target="ext"><b>NamooSocial</b></a>
		...
		<div class="no-gutter row">
			...
			<div class="col-md-7" id="content">
				...
				<div class="col-md-7" id="content">
					<div class="panel">
						<div class="panel-heading"
							style="background-color: #111; color: #fff;">내정보 수정하기</div>
						<div class="panel-body">
							<form class="form-horizontal" action="${ctx}/adjust" method="get">
								<fieldset>
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" readonly="readonly"
												placeholder="사용자ID" name="userId" value="${user.userId}" />
										</div>
									</div>
									<div class="form-group">
