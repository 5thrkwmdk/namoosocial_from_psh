...
<script src="${ctx}/resources/js/myMessages.js"></script>
<style type="text/css">
	...
	<div class="container">
		<div class="no-gutter row">
			...
			<div class="col-md-7" id="content">
				<div class="panel">
					<div class="panel-heading"
						style="background-color: #111; color: #fff;">Top Stories tkrwp</div>
					<div class="panel-body" id="myMessages">
						<!-- <c:forEach var="message" items="${messages}">
							<div class="row">
								<div class="col-md-8">
									...
									<br>
									<br>
									<button class="btn btn-default">More</button>&nbsp;&nbsp;<input type="checkbox"/>
								</div>
							</div>
							<hr>
						</c:forEach>  -->
